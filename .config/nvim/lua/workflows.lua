...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /Users/marv/Documents/ObsidianVault/<cr>")
--
-- convert note to template and remove leading white space
-- vim.keymap.set("n", "<leader>on", "<cmd>ObsidianToday<CR>", { silent = true, desc = "Open today's daily note" })
...
-- vim.keymap.set("n", "<leader>os", ':Telescope find_files search_dirs={"/Users/marv/Documents/ObsidianVault"}<cr>')
-- vim.keymap.set("n", "<leader>oz", ':Telescope live_grep search_dirs={"/Users/marv/Documents/ObsidianVault"}<cr>')
--
